...
export default function RetailBudget({ currency }: RetailBudgetProps) {
  ...
  return (
    <div className="space-y-8">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 mb-2">Retail Stock Budget</h2>
          ...
          <Card className="print-friendly">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Total amount of retail items sold</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <Input
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-2">
                    <Label htmlFor="budgetPercent">Stock Budget (%)</Label>
                    <Tooltip>
                      <TooltipTrigger>
                        <Info size={16} className="text-slate-400" />
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Percentage of net sales allocated to replacing stock</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <Input
